...
public class ACMDMapMovement : SCMDAction
{
    ...
    public override async Task Execute(ScriptEngine engine)
    {
        switch (Parameters["Movement Type"].String)
        {
            ...
            case "Join":
                ...
                string joinRoom = SecondaryParameters["Join"]["Room Number"].GetVar(engine).String;
                ...
                break;
            case "Walk":
                string x = SecondaryParameters["Walk"]["X-Coordinate"].GetVar(engine).String;
                string y = SecondaryParameters["Walk"]["Y-Coordinate"].GetVar(engine).String;
    ...
    public override string ToString()
    {
        ...
        {
            "Jump" => $"Jump to Cell: {SecondaryParameters["Jump"]["Cell"].String}, Pad: {SecondaryParameters["Jump"]["Pad"].String}",
            "Join" => $"Join Map: {SecondaryParameters["Join"]["Map Name"].String}-{SecondaryParameters["Join"]["Room Number"].String}, Cell: {SecondaryParameters["Join"]["Cell"].String}, Pad: {SecondaryParameters["Join"]["Pad"].String}",
            "Walk" => $"Walk to X: {SecondaryParameters["Walk"]["X-Coordinate"].String}, Y: {SecondaryParameters["Walk"]["Y-Coordinate"].String}",
