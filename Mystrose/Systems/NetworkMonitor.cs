...
using Mystrose.Network.Handlers.JSON;
using Mystrose.Network.Handlers.XT;
using Mystrose.Network.Handlers.ZM;
...
public class NetworkMonitor
{
    ...
    protected internal void InvokeEvent(NetworkHandler handlerType, GameHost host, string args)
    {
        (handlerType switch
        {
            NetworkHandler.Game => GameEvent,
            NetworkHandler.Client => ClientEvent,
            _ => null
        })?.Invoke(host, args);
    }
    #endregion
