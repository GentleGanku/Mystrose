...
public class RMSelf(MainAvatar? model = null, World? world = null) : ReadableModel(model ?? new MainAvatar(), world ?? new World())
{

    #region Properties: I/O
    public new MainAvatar Model
    {
        get => (MainAvatar)base.Model;
    }
    #endregion
    ...
    public new MainAvatar ToObject()
    {
        return Model;
    }
