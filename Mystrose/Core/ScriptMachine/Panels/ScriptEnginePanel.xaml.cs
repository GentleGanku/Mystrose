...
namespace Mystrose.Core.ScriptMachine.Panels;
...
public partial class ScriptEnginePanel : UserControl
{
    ...
    #region Properties
    public ScriptCommandDictionary CodelineDict
    {
        get;
        private set;
    }
    ...
    {
        string optKey = (string)CodelineExtrasLabel.Tag;
        string prmName = ((FrameworkElement)input).Name;
        ...
        CodelineExtrasBox.Items.Add(((FrameworkElement)input).Name);
        CodelineExtrasBox.SelectedIndex = 0;
