...
public class ACMDVariableSetter : SCMDAction
{
    ...
    public override string ToString()
    {
        ...
        {
            "Add" => $"Add variable '{Parameters["Variable Name"]}' with value '{SecondaryParameters["Add"]["Variable Value"]}'",
            "Remove" => $"Remove variable '{Parameters["Variable Name"]}'",
            "Update" => $"Update variable '{Parameters["Variable Name"]}' with value '{SecondaryParameters["Update"]["Variable Value"]}' ({SecondaryParameters["Update"]["Operator Type"]})"
        };
    }
    #endregion
