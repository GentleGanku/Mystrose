...
public class ACMDTargetSetter : SCMDAction
{
    ...
    public override string ToString()
    {
        return Parameters["Target Type"].String switch
        {
            ...
            "Player" => "Set target to Player '" + SecondaryParameters["Player"]["Player Name"] + "'",
            "Monster" => "Set target to Monster '" + SecondaryParameters["Monster"]["Tag"] + "'",
            "Random" => $"Set target to Random ({SecondaryParameters["Random"]["Focus Type"]})",
